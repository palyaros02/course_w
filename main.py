...
"""
Создать приложение, позволяющее взаимодействовать с базой данных пекарни.
Название окна - Управление пекарней.
Сверху hbox, состоящий из двух vbox.
В первом vbox два label - Пекарня: название, адрес и Пользователь: имя
Во втором vbox три кнопки - "Новый заказ", "Выход из системы" "Выгрузка данных"
Далее один hbox, состоящий из таблицы с назанием "Заказы" и vbox
Vbox состоит из двух таблиц - "Заказ", показывающей наполнение текущего заказа и "Наличие", показывающей наличие товаров на складе.
У всех таблиц должны быть заголовки.
